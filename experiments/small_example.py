...
class SmallExperiment(Experiment):
    def __init__(self):
        ...
        mc = PartiallyObservedMarkovChain("small_experiment", np.array([[0.9,0.1,0.0],[0.8,0.1,0.1],[0.7,0.2,0.1]]), {0: "a", 1: "b", 2: "a"})
        monitor = QuantitativeMonitor(0.95, q1)
        super().__init__(name, mc, q1, monitor, 10000, 10000)
